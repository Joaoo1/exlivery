defmodule Exlivery.Orders.Item do
  ...
  def build(_description, _category, _unity_price, _qtt), do: {:error, "Invalid parameters"}
  ...
  defp build_item(:error, _description, _category, _qtt), do: {:error, "Invalid parameters"}
end
